...
#
# Parallel loading works for both engines. With RocksDB bulk_load OFF
# (using normal write path + commit_in_the_middle), concurrent writers
# go through memtable -> flush -> compaction without SST ingestion stalls.
