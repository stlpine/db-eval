-- ClickBench queries for MySQL
-- 43 queries from https://github.com/ClickHouse/ClickBench
-- Each query on a separate line, no trailing semicolons (added at execution)
