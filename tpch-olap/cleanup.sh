...
log_info "Cleaning up TPC-H data for $ENGINE"
...
if [ -d "$TPCH_DATA_DIR" ]; then
    log_info "Note: Generated .tbl files still exist at $TPCH_DATA_DIR"
    log_info "To remove them: rm -rf $TPCH_DATA_DIR"
fi
